...
echo -e "${GREEN}================================================${NC}"
echo -e "${GREEN}Building FleetSafeCore + ROS Autonomy Stack Docker Image${NC}"
...
CLONE_URL="https://github.com/Fleet-Safe-VLA/ros-navigation-autonomy-stack.git"
...
echo "  - Install Python dependencies for FleetSafeCore"
echo ""
...
echo -e "${GREEN}Image: fleetsafe_core_autonomy_stack:${IMAGE_TAG}${NC}"
echo -e "${GREEN}SLAM: arise_slam + FASTLIO2 (both included)${NC}"
echo -e "${GREEN}============================================${NC}"
echo ""
