...
The browser imports `@fleetsafe_core/msgs` via [esm.sh](https://esm.sh) and encodes/decodes LCM packets directly - the server just forwards raw binary between WebSocket and UDP multicast.

## Dependencies

Main documentation for TS interop:

- [@fleetsafe_core/lcm](https://jsr.io/@fleetsafe_core/lcm)
- [@fleetsafe_core/msgs](https://jsr.io/@fleetsafe_core/msgs)
