...
from fleetsafe_core.protocol.pubsub.patterns import Glob, pattern_matches
...
if TYPE_CHECKING:
    ...
    from fleetsafe_core.protocol.pubsub.spec import SubscribeAllCapable
