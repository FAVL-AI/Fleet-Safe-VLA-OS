...
Usage:
    python -m fleetsafe_core.control.examples.cartesian_ik_jogger
"""
...
def main() -> None:
    ...
    Note: This only runs the UI. The coordinator must be started separately:
        Terminal 1: fleetsafe_core run coordinator-cartesian-ik-mock
        Terminal 2: python -m fleetsafe_core.control.examples.cartesian_ik_jogger
    """
    run_jogger_ui()
