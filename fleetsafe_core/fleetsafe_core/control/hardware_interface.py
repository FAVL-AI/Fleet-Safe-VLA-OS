...
from fleetsafe_core.hardware.manipulators.spec import ControlMode, ManipulatorAdapter

if TYPE_CHECKING:
    from fleetsafe_core.control.components import HardwareComponent, HardwareId, JointName, JointState
    from fleetsafe_core.hardware.drive_trains.spec import TwistBaseAdapter
...
class ConnectedHardware:
    ...
    def read_state(self) -> dict[JointName, JointState]:
        ...
        """
        from fleetsafe_core.control.components import JointState
...
class ConnectedTwistBase(ConnectedHardware):
    ...
    def __init__(
        ...
        from fleetsafe_core.hardware.drive_trains.spec import TwistBaseAdapter as TwistBaseAdapterProto
