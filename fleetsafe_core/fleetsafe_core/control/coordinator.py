...
from fleetsafe_core.control.components import (
    TWIST_SUFFIX_MAP,
    HardwareComponent,
    HardwareId,
    HardwareType,
...
from fleetsafe_core.control.hardware_interface import ConnectedHardware, ConnectedTwistBase
from fleetsafe_core.control.task import ControlTask
from fleetsafe_core.control.tick_loop import TickLoop
from fleetsafe_core.core.core import rpc
from fleetsafe_core.core.module import Module, ModuleConfig
from fleetsafe_core.core.stream import In, Out
from fleetsafe_core.hardware.drive_trains.spec import (
    TwistBaseAdapter,
)
from fleetsafe_core.hardware.manipulators.spec import ManipulatorAdapter
from fleetsafe_core.msgs.geometry_msgs import (
    PoseStamped,
    Twist,
)
from fleetsafe_core.msgs.sensor_msgs import (
    JointState,
)
from fleetsafe_core.teleop.quest.quest_types import (
    Buttons,
)
...
class ControlCoordinator(Module[ControlCoordinatorConfig]):
    ...
    Example:
        >>> from fleetsafe_core.control import ControlCoordinator
        >>> from fleetsafe_core.hardware.manipulators.xarm import XArmAdapter
        >>>
    ...
    def _create_adapter(self, component: HardwareComponent) -> ManipulatorAdapter:
        ...
        from fleetsafe_core.hardware.manipulators.registry import adapter_registry
    ...
    def _create_twist_base_adapter(self, component: HardwareComponent) -> TwistBaseAdapter:
        ...
        from fleetsafe_core.hardware.drive_trains.registry import twist_base_adapter_registry
    ...
    def _create_task_from_config(self, cfg: TaskConfig) -> ControlTask:
        ...
        if task_type == "trajectory":
            from fleetsafe_core.control.tasks import JointTrajectoryTask, JointTrajectoryTaskConfig
            ...
            from fleetsafe_core.control.tasks import JointServoTask, JointServoTaskConfig
            ...
            from fleetsafe_core.control.tasks import JointVelocityTask, JointVelocityTaskConfig
            ...
            from fleetsafe_core.control.tasks import CartesianIKTask, CartesianIKTaskConfig
            ...
            from fleetsafe_core.control.tasks.teleop_task import TeleopIKTask, TeleopIKTaskConfig
