...
Usage:
    # Run via CLI:
    fleetsafe_core run coordinator-mock           # Mock 7-DOF arm
    fleetsafe_core run coordinator-xarm7          # XArm7 real hardware
    fleetsafe_core run coordinator-dual-mock      # Dual mock arms

    # Or programmatically:
    from fleetsafe_core.control.blueprints import coordinator_mock
...
from fleetsafe_core.msgs.geometry_msgs import PoseStamped, Twist
from fleetsafe_core.msgs.sensor_msgs import JointState
from fleetsafe_core.teleop.quest.quest_types import Buttons
