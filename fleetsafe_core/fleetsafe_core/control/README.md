...
fleetsafe_core run coordinator-mock          # Single 7-DOF mock arm
fleetsafe_core run coordinator-dual-mock     # Dual arms (7+6 DOF)
fleetsafe_core run coordinator-piper-xarm    # Real hardware
...
```python
from fleetsafe_core.control import control_coordinator, HardwareComponent, TaskConfig
...
```python
from fleetsafe_core.control.task import ControlTask, ResourceClaim, JointCommandOutput, ControlMode
