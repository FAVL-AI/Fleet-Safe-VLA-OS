...
Separated from coordinator.py following the FleetSafeCore pattern of
...
from fleetsafe_core.control.task import (
    ControlTask,
    CoordinatorState,
    JointCommandOutput,
    JointStateSnapshot,
...
if TYPE_CHECKING:
    ...
    from fleetsafe_core.control.components import HardwareId, JointName, TaskName
    from fleetsafe_core.control.hardware_interface import ConnectedHardware
    from fleetsafe_core.hardware.manipulators.spec import ControlMode
