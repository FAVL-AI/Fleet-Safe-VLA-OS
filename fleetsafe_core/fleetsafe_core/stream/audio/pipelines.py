...
from fleetsafe_core.stream.audio.node_microphone import SounddeviceAudioSource
...
from fleetsafe_core.stream.audio.stt.node_whisper import WhisperNode
from fleetsafe_core.stream.audio.text.node_stdout import TextPrinterNode
from fleetsafe_core.stream.audio.tts.node_openai import OpenAITTSNode, Voice
