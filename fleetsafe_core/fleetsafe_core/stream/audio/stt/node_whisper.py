...
from fleetsafe_core.stream.audio.base import (
    AbstractAudioConsumer,
    AudioEvent,
)
from fleetsafe_core.stream.audio.text.base import AbstractTextEmitter
...
if __name__ == "__main__":
    from fleetsafe_core.stream.audio.node_key_recorder import KeyRecorder
    from fleetsafe_core.stream.audio.node_microphone import (
        SounddeviceAudioSource,
    )
    from fleetsafe_core.stream.audio.node_normalizer import AudioNormalizer
    from fleetsafe_core.stream.audio.node_output import SounddeviceAudioOutput
    from fleetsafe_core.stream.audio.node_volume_monitor import monitor
    from fleetsafe_core.stream.audio.text.node_stdout import TextPrinterNode
    from fleetsafe_core.stream.audio.tts.node_openai import OpenAITTSNode
    from fleetsafe_core.stream.audio.utils import keepalive
