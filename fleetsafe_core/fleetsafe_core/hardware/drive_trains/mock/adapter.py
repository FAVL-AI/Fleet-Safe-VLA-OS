...
Usage:
    >>> from fleetsafe_core.hardware.drive_trains.mock import MockTwistBaseAdapter
...
if TYPE_CHECKING:
    from fleetsafe_core.hardware.drive_trains.registry import TwistBaseAdapterRegistry
