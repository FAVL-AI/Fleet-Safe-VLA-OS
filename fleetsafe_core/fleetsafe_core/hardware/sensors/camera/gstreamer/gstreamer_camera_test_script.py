...
from fleetsafe_core.hardware.sensors.camera.gstreamer.gstreamer_camera import GstreamerCameraModule
from fleetsafe_core.msgs.sensor_msgs import Image
from fleetsafe_core.protocol import pubsub
...
def main() -> None:
    ...
    camera = fleetsafe_core.deploy(  # type: ignore[attr-defined]
    ...
    logger.info(
        f"  python3 fleetsafe_core/hardware/gstreamer_sender.py --device /dev/video0 --host 0.0.0.0 --port {args.port}"
    )
