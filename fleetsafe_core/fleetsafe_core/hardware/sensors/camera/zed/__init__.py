...
from fleetsafe_core.msgs.sensor_msgs.CameraInfo import CalibrationProvider
...
if HAS_ZED_SDK:
    from fleetsafe_core.hardware.sensors.camera.zed.camera import ZEDCamera, ZEDModule, zed_camera
else:
