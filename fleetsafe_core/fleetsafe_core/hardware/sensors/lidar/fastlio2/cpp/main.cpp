...
//
// FAST-LIO2 + Livox Mid-360 native module for fleetsafe_core NativeModule framework.
//
...
#include "fleetsafe_core_native_module.hpp"
#include "voxel_map.hpp"

// fleetsafe_core LCM message headers
...
using fleetsafe_core::time_from_seconds;
using fleetsafe_core::make_header;
...
int main(int argc, char** argv) {
    fleetsafe_core::NativeModule mod(argc, argv);
