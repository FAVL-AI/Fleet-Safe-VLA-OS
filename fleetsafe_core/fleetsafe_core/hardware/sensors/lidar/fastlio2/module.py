...
Usage::
    ...
    from fleetsafe_core.hardware.sensors.lidar.fastlio2.module import FastLio2
...
from fleetsafe_core.core.native_module import NativeModule, NativeModuleConfig
from fleetsafe_core.core.stream import Out  # noqa: TC001
from fleetsafe_core.hardware.sensors.lidar.livox.ports import (
    SDK_CMD_DATA_PORT,
...
from fleetsafe_core.msgs.nav_msgs.Odometry import Odometry  # noqa: TC001
from fleetsafe_core.msgs.sensor_msgs.PointCloud2 import PointCloud2  # noqa: TC001
from fleetsafe_core.spec import mapping, perception
