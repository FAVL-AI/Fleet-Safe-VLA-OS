...
from fleetsafe_core.msgs.geometry_msgs import PoseStamped, Quaternion, VectorLike
from fleetsafe_core.msgs.nav_msgs import CostValues, OccupancyGrid, Path
from fleetsafe_core.utils.logging_config import setup_logger

# Try to import C++ extension for faster pathfinding
try:
    from fleetsafe_core.navigation.replanning_a_star.min_cost_astar_ext import (
