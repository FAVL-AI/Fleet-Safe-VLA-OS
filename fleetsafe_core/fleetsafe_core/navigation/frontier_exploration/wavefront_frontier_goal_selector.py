...
"""
Simple wavefront frontier exploration algorithm implementation using fleetsafe_core types.

This module provides frontier detection and exploration goal selection
for autonomous navigation using the fleetsafe_core Costmap and Vector types.
"""
...
from fleetsafe_core.msgs.geometry_msgs import PoseStamped, Vector3
from fleetsafe_core.msgs.nav_msgs import CostValues, OccupancyGrid
from fleetsafe_core.utils.logging_config import setup_logger
from fleetsafe_core.utils.transform_utils import get_distance
