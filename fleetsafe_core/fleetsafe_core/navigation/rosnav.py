...
from fleetsafe_core.msgs.nav_msgs import Path
from fleetsafe_core.msgs.sensor_msgs import Joy, PointCloud2
from fleetsafe_core.msgs.std_msgs import Bool, Int8
from fleetsafe_core.msgs.tf2_msgs.TFMessage import TFMessage
from fleetsafe_core.navigation.base import NavigationInterface, NavigationState
from fleetsafe_core.utils.logging_config import setup_logger
from fleetsafe_core.utils.transform_utils import euler_to_quaternion
...
def deploy(fleetsafe_core: ModuleCoordinator):  # type: ignore[no-untyped-def]
    nav = fleetsafe_core.deploy(ROSNav)  # type: ignore[attr-defined]
