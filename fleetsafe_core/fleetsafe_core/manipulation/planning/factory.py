...
def create_kinematics(
    ...
    **kwargs: Any,
    ...
    if name == "jacobian":
        from fleetsafe_core.manipulation.planning.kinematics.jacobian_ik import JacobianIK

        return JacobianIK(**kwargs)
    elif name == "drake_optimization":
        from fleetsafe_core.manipulation.planning.kinematics.drake_optimization_ik import (
            DrakeOptimizationIK,
        )
...
def create_planner(
    ...
    **kwargs: Any,
    ...
    if name == "rrt_connect":
        from fleetsafe_core.manipulation.planning.planners.rrt_planner import RRTConnectPlanner
