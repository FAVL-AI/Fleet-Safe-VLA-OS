...
if TYPE_CHECKING:
    ...
    from fleetsafe_core.manipulation.planning.spec import WorldSpec
...
class WorldObstacleMonitor:
    ...
    - Perception detections (Detection3D from fleetsafe_core.msgs.vision_msgs)
    ...
    def on_detections(self, detections: list[Detection3D]) -> None:
        ...
        Args:
            detections: List of Detection3D messages from fleetsafe_core.msgs.vision_msgs
        """
        if not self._running:
            return
    ...
    def get_cached_objects(self) -> list[Object]:
        ...
        """
        from fleetsafe_core.perception.detection.type.detection3d.object import Object as _Object
    ...
    def _object_to_obstacle(self, obj: object) -> Obstacle:
        ...
        if self._use_mesh_obstacles and obj.pointcloud is not None:
            try:
                from fleetsafe_core.manipulation.planning.utils.mesh_utils import (
