...
from fleetsafe_core.manipulation.planning.factory import create_world
from fleetsafe_core.manipulation.planning.monitor.world_obstacle_monitor import WorldObstacleMonitor
from fleetsafe_core.manipulation.planning.monitor.world_state_monitor import WorldStateMonitor
from fleetsafe_core.msgs.geometry_msgs import PoseStamped
...
if TYPE_CHECKING:
    ...
    from fleetsafe_core.manipulation.planning.spec import (
    ...
    from fleetsafe_core.msgs.vision_msgs import Detection3D
    from fleetsafe_core.perception.detection.type.detection3d.object import Object
...
class WorldMonitor:
    ...
    def on_detections(self, detections: list[Detection3D]) -> None:
        """Handle perception detections (Detection3D from fleetsafe_core.msgs.vision_msgs)."""
        if self._obstacle_monitor is not None:
    ...
    def get_link_pose(
        ...
        """
        from fleetsafe_core.msgs.geometry_msgs import Quaternion
