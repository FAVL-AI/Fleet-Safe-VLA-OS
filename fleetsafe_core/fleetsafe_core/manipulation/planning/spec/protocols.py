...
Use factory functions from fleetsafe_core.manipulation.planning.factory to create instances.
"""
...
if TYPE_CHECKING:
    ...
    from fleetsafe_core.manipulation.planning.spec.config import RobotModelConfig
    from fleetsafe_core.manipulation.planning.spec.types import (
        IKResult,
        JointPath,
        Obstacle,
        PlanningResult,
