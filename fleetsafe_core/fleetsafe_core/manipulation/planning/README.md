...
fleetsafe_core run xarm7-planner-coordinator                                    # terminal 1
python -i -m fleetsafe_core.manipulation.planning.examples.manipulation_client  # terminal 2
```
...
from fleetsafe_core.manipulation import ManipulationModule
...
pytest fleetsafe_core/manipulation/test_manipulation_unit.py -v

# Integration tests (requires Drake)
pytest fleetsafe_core/e2e_tests/test_manipulation_module.py -v
```
