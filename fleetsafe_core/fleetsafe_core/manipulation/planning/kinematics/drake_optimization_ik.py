...
from fleetsafe_core.manipulation.planning.spec import IKResult, IKStatus, WorldRobotID, WorldSpec
from fleetsafe_core.manipulation.planning.utils.kinematics_utils import compute_pose_error
from fleetsafe_core.msgs.geometry_msgs import PoseStamped, Transform
from fleetsafe_core.msgs.sensor_msgs import JointState
from fleetsafe_core.utils.logging_config import setup_logger
from fleetsafe_core.utils.transform_utils import pose_to_matrix
...
class DrakeOptimizationIK:
    ...
    def _validate_world(self, world: WorldSpec) -> IKResult | None:
        from fleetsafe_core.manipulation.planning.world.drake_world import DrakeWorld
