...
from fleetsafe_core.constants import FLEETSAFE_CORE_PROJECT_ROOT
from fleetsafe_core.core.core import rpc
from fleetsafe_core.core.docker_runner import DockerModule as DockerRunner
from fleetsafe_core.core.stream import In  # noqa: TC001
from fleetsafe_core.manipulation.grasping.graspgen_module import GraspGenModule
from fleetsafe_core.manipulation.manipulation_module import (
    ManipulationModule,
    ManipulationModuleConfig,
)
from fleetsafe_core.msgs.geometry_msgs import Pose, Quaternion, Vector3
from fleetsafe_core.perception.detection.type.detection3d.object import (
...
if TYPE_CHECKING:
    from fleetsafe_core.msgs.geometry_msgs import PoseArray
...
class PickAndPlaceModuleConfig(ManipulationModuleConfig):
    ...
    graspgen_docker_image: str = "fleetsafe_core-graspgen:latest"
    ...
    graspgen_visualization_output_path: Path = field(
        default_factory=lambda: Path.home() / ".fleetsafe_core" / "graspgen" / "visualization.json"
    )
...
class PickAndPlaceModule(ManipulationModule):
    ...
    def _get_graspgen(self) -> DockerRunner:
        ...
        with self._lock:
            ...
            graspgen = DockerRunner(
                ...
                docker_build_context=FLEETSAFE_CORE_PROJECT_ROOT,
    ...
    def _compute_pre_grasp_pose(self, grasp_pose: Pose, offset: float = 0.10) -> Pose:
        ...
        """
        from fleetsafe_core.utils.transform_utils import offset_distance
