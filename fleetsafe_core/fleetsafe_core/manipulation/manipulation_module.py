...
from fleetsafe_core.manipulation.planning import (
    JointPath,
...
from fleetsafe_core.manipulation.planning.monitor import WorldMonitor
...
from fleetsafe_core.msgs.trajectory_msgs import JointTrajectory
from fleetsafe_core.utils.logging_config import setup_logger

if TYPE_CHECKING:
    from fleetsafe_core.core.rpc_client import RPCClient
...
class ManipulationModule(Module):
    ...
    def preview_path(self, duration: float = 3.0, robot_name: RobotName | None = None) -> bool:
        ...
        """
        from fleetsafe_core.manipulation.planning.utils.path_utils import interpolate_path
    ...
    def _get_coordinator_client(self) -> RPCClient | None:
        ...
        if self._coordinator_client is None:
            from fleetsafe_core.control.coordinator import ControlCoordinator
            from fleetsafe_core.core.rpc_client import RPCClient
