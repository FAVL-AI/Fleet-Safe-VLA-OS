...
from fleetsafe_core.core.docker_runner import DockerModuleConfig
...
from fleetsafe_core.utils.transform_utils import matrix_to_pose
...
class GraspGenConfig(DockerModuleConfig):
    ...
    # Docker defaults
    docker_image: str = "fleetsafe_core-graspgen:latest"
    docker_gpus: str = "all"
