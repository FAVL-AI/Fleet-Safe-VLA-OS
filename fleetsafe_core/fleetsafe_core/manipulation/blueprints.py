...
Quick start:
    ...
    fleetsafe_core run xarm6-planner-only

    # 2. Keyboard teleop with mock arm:
    fleetsafe_core run keyboard-teleop-xarm7

    # 3. Interactive RPC client (plan, preview, execute from Python):
    fleetsafe_core run xarm7-planner-coordinator
    python -i -m fleetsafe_core.manipulation.planning.examples.manipulation_client
"""
...
from fleetsafe_core.control.components import HardwareComponent, HardwareType, make_joints
from fleetsafe_core.control.coordinator import TaskConfig, control_coordinator
from fleetsafe_core.core.blueprints import autoconnect
from fleetsafe_core.core.transport import LCMTransport
from fleetsafe_core.hardware.sensors.camera.realsense import realsense_camera
from fleetsafe_core.manipulation.manipulation_module import manipulation_module
from fleetsafe_core.manipulation.pick_and_place_module import pick_and_place_module
from fleetsafe_core.manipulation.planning.spec import RobotModelConfig
from fleetsafe_core.msgs.geometry_msgs import PoseStamped, Quaternion, Transform, Vector3
from fleetsafe_core.msgs.sensor_msgs import JointState
from fleetsafe_core.perception.object_scene_registration import object_scene_registration_module
from fleetsafe_core.robot.foxglove_bridge import foxglove_bridge  # TODO: migrate to rerun
from fleetsafe_core.utils.data import get_data
...
# Usage: fleetsafe_core run xarm7-planner-coordinator
...
# Usage: fleetsafe_core run coordinator-mock, then fleetsafe_core run xarm7-planner-coordinator-agent
...
# Usage: fleetsafe_core run coordinator-mock, then fleetsafe_core run xarm-perception
...
# Usage: fleetsafe_core run coordinator-mock, then fleetsafe_core run xarm-perception-agent
