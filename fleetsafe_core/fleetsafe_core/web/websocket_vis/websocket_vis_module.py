...
"""
WebSocket Visualization Module for FleetSafeCore navigation and mapping.
...
from fleetsafe_core_lcm.std_msgs import Bool  # type: ignore[import-untyped]
...
from fleetsafe_core.mapping.occupancy.gradient import gradient
from fleetsafe_core.mapping.occupancy.inflation import simple_inflate
from fleetsafe_core.mapping.types import LatLon
from fleetsafe_core.msgs.geometry_msgs import PoseStamped, Twist, TwistStamped, Vector3
from fleetsafe_core.msgs.nav_msgs import OccupancyGrid, Path
...
class WebsocketVisModule(Module):
    ...
    def start(self) -> None:
        ...
        if self._global_config.viewer == "rerun-web":
            ...
            logger.info(f"Fleet-Safe VLA Command Center: {url}")
    ...
    def _create_server(self) -> None:
        ...
        async def serve_command_center(request):  # type: ignore[no-untyped-def]
            ...
            if index_file.exists():
                ...
                return Response(
                    content="Command center not built. Run: cd fleetsafe_core/web/command-center-extension && npm install && npm run build:standalone",
                    status_code=503,
