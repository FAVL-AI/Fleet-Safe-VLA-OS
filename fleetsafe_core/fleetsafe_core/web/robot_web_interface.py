...
"""
Robot Web Interface wrapper for FLEETSAFE_CORE.
Provides a clean interface to the dimensional-interface FastAPI server.
"""

from fleetsafe_core.web.fleetsafe_core_interface.api.server import FastAPIServer


class RobotWebInterface(FastAPIServer):
    """Wrapper class for the fleetsafe_core-interface FastAPI server."""
