...
## Integration with FLEETSAFE_CORE Agents

See FleetSafeCore Documentation for more info.

```python
from fleetsafe_core.agents_deprecated.agent import OpenAIAgent
from fleetsafe_core.robot.unitree.unitree_go2 import UnitreeGo2
from fleetsafe_core.robot.unitree.unitree_skills import MyUnitreeSkills
