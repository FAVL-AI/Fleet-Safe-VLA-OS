...
```bash
fleetsafe_core run arm-teleop           # Basic arm teleop
fleetsafe_core run arm-teleop-xarm6     # XArm6
fleetsafe_core run arm-teleop-piper     # Piper
fleetsafe_core run arm-teleop-dual      # Dual arm
```
