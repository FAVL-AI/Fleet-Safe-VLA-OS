...
Wraps a pygame UI as a FleetSafeCore Module so it can be composed with coordinator
...
from fleetsafe_core.control.examples.cartesian_ik_jogger import JogState
...
class KeyboardTeleopModule(Module[KeyboardTeleopConfig]):
    """Pygame-based cartesian keyboard teleop as a FleetSafeCore Module.
