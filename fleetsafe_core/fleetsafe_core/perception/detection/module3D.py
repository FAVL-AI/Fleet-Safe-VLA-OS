...
from fleetsafe_core.msgs.vision_msgs import Detection2DArray
from fleetsafe_core.perception.detection.module2D import Detection2DModule
from fleetsafe_core.perception.detection.type.detection2d.imageDetections2D import ImageDetections2D
from fleetsafe_core.perception.detection.type.detection3d import Detection3DPC
from fleetsafe_core.perception.detection.type.detection3d.imageDetections3DPC import ImageDetections3DPC
from fleetsafe_core.types.timestamped import align_timestamped
from fleetsafe_core.utils.reactive import backpressure
...
class Detection3DModule(Detection2DModule):
    ...
    def ask_vlm(self, question: str) -> str:
        ...
        """
        from fleetsafe_core.models.vl.qwen import QwenVlModel
...
def deploy(  # type: ignore[no-untyped-def]
    ...
    **kwargs,
    ...
    detector = fleetsafe_core.deploy(Detection3DModule, camera_info=camera.hardware_camera_info, **kwargs)  # type: ignore[attr-defined]
