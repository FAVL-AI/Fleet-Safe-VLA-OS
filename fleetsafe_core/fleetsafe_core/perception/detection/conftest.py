...
from fleetsafe_core.perception.detection.module3D import Detection3DModule
from fleetsafe_core.perception.detection.moduleDB import ObjectDBModule
from fleetsafe_core.perception.detection.type import (
    Detection2D,
    Detection3DPC,
    ImageDetections2D,
    ImageDetections3DPC,
)
from fleetsafe_core.protocol.tf import TF
from fleetsafe_core.robot.unitree.go2 import connection
from fleetsafe_core.robot.unitree.type.odometry import Odometry
...
def get_moment_2d(get_moment) -> Generator[Callable[[], Moment2D], None, None]:
    from fleetsafe_core.perception.detection.detectors import Yolo2DDetector
