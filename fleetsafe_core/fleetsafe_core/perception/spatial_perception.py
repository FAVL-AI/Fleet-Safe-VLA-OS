...
from fleetsafe_core.agents_deprecated.memory.image_embedding import ImageEmbeddingProvider
from fleetsafe_core.agents_deprecated.memory.spatial_vector_db import SpatialVectorDB
from fleetsafe_core.agents_deprecated.memory.visual_memory import VisualMemory
...
from fleetsafe_core.core.stream import In
from fleetsafe_core.msgs.sensor_msgs import Image
from fleetsafe_core.types.robot_location import RobotLocation
from fleetsafe_core.utils.logging_config import setup_logger

if TYPE_CHECKING:
    from fleetsafe_core.msgs.geometry_msgs import Vector3

_OUTPUT_DIR = FLEETSAFE_CORE_PROJECT_ROOT / "assets" / "output"
...
class SpatialMemory(Module):
    """
    A FleetSafeCore module for building and querying Robot spatial memory.
...
def deploy(  # type: ignore[no-untyped-def]
    ...
    spatial_memory = fleetsafe_core.deploy(SpatialMemory, db_path="/tmp/spatial_memory_db")  # type: ignore[attr-defined]
