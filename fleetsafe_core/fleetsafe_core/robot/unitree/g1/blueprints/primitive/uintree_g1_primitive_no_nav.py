...
from fleetsafe_core.hardware.sensors.camera import zed
from fleetsafe_core.hardware.sensors.camera.module import camera_module  # type: ignore[attr-defined]
from fleetsafe_core.hardware.sensors.camera.webcam import Webcam
from fleetsafe_core.mapping.costmapper import cost_mapper
from fleetsafe_core.mapping.voxels import voxel_mapper
from fleetsafe_core.msgs.geometry_msgs import PoseStamped, Quaternion, Transform, Twist, Vector3
from fleetsafe_core.msgs.nav_msgs import Odometry, Path
from fleetsafe_core.msgs.sensor_msgs import Image, PointCloud2
from fleetsafe_core.msgs.std_msgs import Bool
from fleetsafe_core.navigation.frontier_exploration import wavefront_frontier_explorer
from fleetsafe_core.protocol.pubsub.impl.lcmpubsub import LCM
from fleetsafe_core.web.websocket_vis.websocket_vis_module import websocket_vis
...
if global_config.viewer == "foxglove":
    from fleetsafe_core.robot.foxglove_bridge import foxglove_bridge

    _with_vis = autoconnect(foxglove_bridge())
elif global_config.viewer.startswith("rerun"):
    from fleetsafe_core.visualization.rerun.bridge import _resolve_viewer_mode, rerun_bridge
