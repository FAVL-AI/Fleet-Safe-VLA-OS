...
from fleetsafe_core.mapping.pointclouds.accumulators.general import GeneralPointCloudAccumulator
from fleetsafe_core.mapping.pointclouds.accumulators.protocol import PointCloudAccumulator
from fleetsafe_core.mapping.pointclouds.occupancy import general_occupancy
from fleetsafe_core.msgs.nav_msgs import OccupancyGrid
from fleetsafe_core.msgs.sensor_msgs import PointCloud2
from fleetsafe_core.robot.unitree.go2.connection import Go2ConnectionProtocol
...
def deploy(fleetsafe_core: ModuleCoordinator, connection: Go2ConnectionProtocol):  # type: ignore[no-untyped-def]
    mapper = fleetsafe_core.deploy(Map, global_publish_interval=1.0)  # type: ignore[attr-defined]
