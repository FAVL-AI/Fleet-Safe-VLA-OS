...
from fleetsafe_core.robot.unitree.type.lidar import pointcloud2_from_webrtc_lidar
...
def process_data():  # type: ignore[no-untyped-def]
    ...
    from fleetsafe_core.perception.detection.module2D import (  # type: ignore[attr-defined]
        Detection2DModule,
