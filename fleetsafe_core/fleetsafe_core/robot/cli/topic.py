...
from fleetsafe_core.protocol.pubsub.impl.lcmpubsub import LCMPubSubBase

_modules_to_try = [
    "fleetsafe_core.msgs.geometry_msgs",
    "fleetsafe_core.msgs.nav_msgs",
    "fleetsafe_core.msgs.sensor_msgs",
    "fleetsafe_core.msgs.std_msgs",
    "fleetsafe_core.msgs.vision_msgs",
    "fleetsafe_core.msgs.foxglove_msgs",
    "fleetsafe_core.msgs.tf2_msgs",
]
...
def topic_echo(topic: str, type_name: str | None) -> None:
    ...
    from fleetsafe_core.protocol.service.lcmservice import autoconf
    ...
    def on_msg(channel: str, data: bytes) -> None:
        ...
        module = importlib.import_module(f"fleetsafe_core.msgs.{pkg}")
