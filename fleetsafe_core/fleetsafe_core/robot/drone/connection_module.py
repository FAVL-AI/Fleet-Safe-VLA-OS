...
"""FleetSafeCore module wrapper for drone connection."""
...
from fleetsafe_core.robot.drone.dji_video_stream import DJIDroneVideoStream
from fleetsafe_core.robot.drone.mavlink_connection import MavlinkConnection
...
class DroneConnectionModule(Module):
    ...
    def start(self) -> None:
        ...
        if self.connection_string == "replay":
            ...
            from fleetsafe_core.robot.drone.mavlink_connection import FakeMavlinkConnection
        ...
        if self.video_stream.start():
            ...
            # from fleetsafe_core.utils.testing import TimedSensorStorage
