...
IGNORED_FILES: set[str] = {
    "fleetsafe_core/robot/all_blueprints.py",
    "fleetsafe_core/robot/get_all_blueprints.py",
    "fleetsafe_core/robot/test_all_blueprints.py",
    "fleetsafe_core/robot/test_all_blueprints_generation.py",
    "fleetsafe_core/core/blueprints.py",
    "fleetsafe_core/core/test_blueprints.py",
}
BLUEPRINT_METHODS = {"transports", "global_config", "remappings", "requirements", "configurators"}


def test_all_blueprints_is_current() -> None:
    root = FLEETSAFE_CORE_PROJECT_ROOT / "fleetsafe_core"
    ...
    if "CI" in os.environ:
        ...
        if current_content != generated_content:
            ...
            pytest.fail(
                ...
                f"`pytest fleetsafe_core/robot/test_all_blueprints_generation.py` locally to update.\n\n"
                f"Diff:\n{diff_str}"
            )
    else:
