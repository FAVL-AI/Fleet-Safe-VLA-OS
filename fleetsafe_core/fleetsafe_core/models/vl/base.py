...
from fleetsafe_core.protocol.service import Configurable  # type: ignore[attr-defined]
from fleetsafe_core.utils.data import get_data
from fleetsafe_core.utils.decorators import retry
from fleetsafe_core.utils.llm_utils import extract_json

if TYPE_CHECKING:
    from fleetsafe_core.perception.detection.type import Detection2DBBox, Detection2DPoint, ImageDetections2D
...
def vlm_detection_to_detection2d(
    ...
    from fleetsafe_core.perception.detection.type import Detection2DBBox
...
def vlm_point_to_detection2d_point(
    ...
    """
    from fleetsafe_core.perception.detection.type import Detection2DPoint
