...
from fleetsafe_core.models.base import LocalModel
from fleetsafe_core.models.embedding.base import Embedding, EmbeddingModel, EmbeddingModelConfig
...
# into fleetsafe_core/data/models_torchreid/
