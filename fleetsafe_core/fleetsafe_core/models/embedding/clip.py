...
from fleetsafe_core.models.base import HuggingFaceModel
from fleetsafe_core.models.embedding.base import Embedding, EmbeddingModel, HuggingFaceEmbeddingModelConfig
