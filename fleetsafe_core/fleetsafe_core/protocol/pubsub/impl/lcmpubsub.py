...
from fleetsafe_core.protocol.pubsub.encoders import (
    JpegEncoderMixin,
    LCMEncoderMixin,
    PickleEncoderMixin,
)
from fleetsafe_core.protocol.pubsub.patterns import Glob
from fleetsafe_core.protocol.pubsub.spec import AllPubSub
from fleetsafe_core.protocol.service.lcmservice import LCMConfig, LCMService, autoconf
...
class Topic:
    ...
    lcm_type: type[FleetSafeCoreMsg] | None = None
    ...
    @staticmethod
    def from_channel_str(channel: str, default_lcm_type: type[FleetSafeCoreMsg] | None = None) -> Topic:
        ...
        """
        from fleetsafe_core.msgs import resolve_msg_type
