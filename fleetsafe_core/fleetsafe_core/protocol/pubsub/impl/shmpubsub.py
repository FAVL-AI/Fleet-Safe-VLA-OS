...
from fleetsafe_core.protocol.pubsub.encoders import LCMEncoderMixin, PickleEncoderMixin
from fleetsafe_core.protocol.pubsub.impl.lcmpubsub import Topic
from fleetsafe_core.protocol.pubsub.shm.ipc_factory import CpuShmChannel
...
class SharedMemoryConfig:
    prefer: str = "auto"  # "auto" | "cpu"  (FLEETSAFE_CORE_IPC_BACKEND overrides), TODO: "cuda"
...
class SharedMemoryPubSubBase(PubSub[str, Any]):
    ...
    def start(self) -> None:
        ...
        backend = os.getenv("FLEETSAFE_CORE_IPC_BACKEND", pref).lower()
