...
from fleetsafe_core.protocol.service.system_configurator.base import (
    _is_root_user,
    _read_sysctl_int,
    _write_sysctl_int,
)
...
class TestBufferConfiguratorLinux:
    def test_check_returns_true_when_buffers_sufficient(self) -> None:
        ...
        with patch("fleetsafe_core.protocol.service.system_configurator.lcm._read_sysctl_int") as mock_read:
    ...
    def test_fix_writes_needed_values(self) -> None:
        ...
        configurator.needs = [("net.core.rmem_max", IDEAL_RMEM_SIZE)]
        with patch(
            "fleetsafe_core.protocol.service.system_configurator.lcm._write_sysctl_int"
        ) as mock_write:
            configurator.fix()
...
class TestClockSyncConfigurator:
    ...
    def test_explanation_on_linux_with_ntpdate(self) -> None:
        ...
        with (
            patch(
                "fleetsafe_core.protocol.service.system_configurator.clock_sync.platform.system",
                return_value="Linux",
            ),
            patch(
                "fleetsafe_core.protocol.service.system_configurator.clock_sync.shutil.which",
