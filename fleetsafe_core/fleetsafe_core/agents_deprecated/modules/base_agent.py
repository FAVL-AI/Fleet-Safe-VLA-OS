...
"""Base agent module that wraps BaseAgent for FleetSafeCore module usage."""

import threading
from typing import Any

from fleetsafe_core.agents_deprecated.agent_message import AgentMessage
from fleetsafe_core.agents_deprecated.agent_types import AgentResponse
...
try:
    ...
    from fleetsafe_core.agents_deprecated.modules.base import BaseAgent

logger = setup_logger()


class BaseAgentModule(BaseAgent, Module):  # type: ignore[misc]
    """Agent module that inherits from BaseAgent and adds FleetSafeCore module interface.

    This provides a thin wrapper around BaseAgent functionality, exposing it
    through the FleetSafeCore module system with RPC methods and stream I/O.
    """
    ...
    def __init__(  # type: ignore[no-untyped-def]
        ...
        **kwargs,
        ...
        """
        # Initialize Module first (important for FleetSafeCore)
