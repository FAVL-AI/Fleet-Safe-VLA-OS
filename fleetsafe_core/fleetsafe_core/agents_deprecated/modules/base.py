...
from fleetsafe_core.agents_deprecated.agent_types import AgentResponse, ConversationHistory, ToolCall
...
try:
    ...
    from fleetsafe_core.agents_deprecated.modules.gateway import UnifiedGatewayClient
