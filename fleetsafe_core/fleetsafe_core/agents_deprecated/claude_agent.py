...
"""Claude agent implementation for the FLEETSAFE_CORE agent framework.

This module provides a ClaudeAgent class that implements the LLMAgent interface
for Anthropic's Claude models. It handles conversion between the FLEETSAFE_CORE skill format
...
# Local imports
from fleetsafe_core.agents_deprecated.agent import LLMAgent
...
class ClaudeAgent(LLMAgent):
    ...
    def _convert_tools_to_claude_format(self, tools: list[dict[str, Any]]) -> list[dict[str, Any]]:
        """
        Converts FLEETSAFE_CORE tools to Claude format.

        Args:
            tools: List of tools in FLEETSAFE_CORE format.
