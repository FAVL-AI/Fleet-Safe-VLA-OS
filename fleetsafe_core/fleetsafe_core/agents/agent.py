...
from fleetsafe_core.agents.system_prompt import SYSTEM_PROMPT
from fleetsafe_core.agents.utils import pretty_print_langchain_message
from fleetsafe_core.core.core import rpc
from fleetsafe_core.core.module import Module, ModuleConfig, SkillInfo
from fleetsafe_core.core.rpc_client import RpcCall, RPCClient
from fleetsafe_core.core.stream import In, Out
from fleetsafe_core.protocol.rpc import RPCSpec
...
class Agent(Module[AgentConfig]):
    ...
    def on_system_modules(self, modules: list[RPCClient]) -> None:
        ...
        if self.config.model.startswith("ollama:"):
            from fleetsafe_core.agents.ollama_agent import ensure_ollama_model
        ...
        if self.config.model_fixture is not None:
            from fleetsafe_core.agents.testing import MockModel
