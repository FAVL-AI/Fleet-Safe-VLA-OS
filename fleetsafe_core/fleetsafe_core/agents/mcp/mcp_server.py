...
if TYPE_CHECKING:
    ...
    from fleetsafe_core.core.module import SkillInfo
...
class McpServer(Module):
    ...
    def server_status(self) -> str:
        ...
        from fleetsafe_core.core.run_registry import get_most_recent
    ...
    def agent_send(self, message: str) -> str:
        """Send a message to the running FleetSafeCore agent via LCM."""
        if not message:
