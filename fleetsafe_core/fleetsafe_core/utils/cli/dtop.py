...
Usage:
    uv run python -m fleetsafe_core.utils.cli.dtop [--topic /fleetsafe_core/resource_stats]
"""
...
from fleetsafe_core.utils.cli import theme
...
class ResourceSpyApp(App[None]):
    ...
    def __init__(self, topic_name: str = "/fleetsafe_core/resource_stats") -> None:
        super().__init__()
    ...
    def _refresh(self) -> None:
        ...
        if data is None:
            ...
            waiting = Panel(
                Text(
                    "use `fleetsafe_core --dtop ...` to emit stats",
...
def main() -> None:
    ...
    topic = "/fleetsafe_core/resource_stats"
