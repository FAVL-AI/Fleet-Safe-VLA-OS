...
def import_cli_in_background() -> None:
    ...
    try:
        from fleetsafe_core.utils.cli.human.humancli import main as humancli_main
...
def run_banner_animation() -> None:
    ...
    animation_style = os.environ.get("FLEETSAFE_CORE_BANNER_ANIMATION", random.choice(random_anim)).lower()
