...
from fleetsafe_core.utils.generic import truncate_display_string
...
class HumanCLIApp(App):  # type: ignore[type-arg]
    """IRC-like interface for interacting with FleetSafeCore agents."""
    ...
    def on_mount(self) -> None:
        ...
        self._add_system_message("Connected to FleetSafeCore Agent Interface")
