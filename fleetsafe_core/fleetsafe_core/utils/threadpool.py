...
"""Thread pool functionality for parallel execution in the FleetSafeCore framework.
...
def get_max_workers() -> int:
    ...
    Returns:
        int: The number of workers, configurable via the FLEETSAFE_CORE_MAX_WORKERS
        environment variable, defaulting to 4 times the CPU count.
    """
    env_value = os.getenv("FLEETSAFE_CORE_MAX_WORKERS", "")
