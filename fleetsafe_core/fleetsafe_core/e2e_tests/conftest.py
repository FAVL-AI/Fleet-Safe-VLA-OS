...
from fleetsafe_core.core.transport import pLCMTransport
from fleetsafe_core.e2e_tests.conf_types import StartPersonTrack
from fleetsafe_core.e2e_tests.fleetsafe_core_cli_call import FleetSafeCoreCliCall
from fleetsafe_core.e2e_tests.lcm_spy import LcmSpy
from fleetsafe_core.msgs.geometry_msgs import PoseStamped, Quaternion
from fleetsafe_core.msgs.geometry_msgs.Vector3 import make_vector3
from fleetsafe_core.msgs.std_msgs.Bool import Bool
from fleetsafe_core.simulation.mujoco.person_on_track import PersonTrackPublisher
...
@pytest.fixture
def start_blueprint() -> Iterator[Callable[[str], FleetSafeCoreCliCall]]:
    fleetsafe_core_robot_call = FleetSafeCoreCliCall()

    def set_name_and_start(*demo_args: str) -> FleetSafeCoreCliCall:
        fleetsafe_core_robot_call.demo_args = list(demo_args)
        fleetsafe_core_robot_call.start()
        return fleetsafe_core_robot_call

    yield set_name_and_start

    fleetsafe_core_robot_call.stop()
